...
<title>The Outlier &#8211; Book Store</title>
<style>
		...
		<div class="hero page_title">
			<div class="container">
				...
				<div class="loop-meta">
					...
					<h2 class="page_title col-md-offset-1">THE OUTLIER</h2>
						...
						<div class="featured_book">
							...
							<div
								...
								<figure class="col-md-5 featured-image-holder">
									<a
										href="#"
										title="The outlier by Kimberly Mccreight""><img
										src="images/the-outliers-kimberly-mccreight.jpg"
										alt="The Outlier &amp; "
										class="tokokoo-featured-product" /></a>
									<a
										href="http://tokokoodemo.us/papirus/books/?wc-api=wcxp_quick_view&product=2035&ajax=true"
										title="The Outliers by Kimberly Mccreight"
								...
								<div class="product_desc col-md-5">
									<p class="author">
										By <a
											href="outlier">KIMBERLY McCreight
											</a>
									</p>
									<h3 class="item-title">
										<a
											href="#"
											title="Thinking with Type, 2nd revised and expanded edition: A Critical Guide for Designers, Writers, Editors, &#038; Students">A stunning novel that would let you remain dazed for a while</a>
									</h3>
									It all starts with a text: Please, Wylie, I need your help.

Wylie hasn’t heard from Cassie in over a week, not since their last fight. But that doesn’t matter. Cassie’s in trouble, so Wylie decides to do what she has done so many times before: save her best friend from herself.

This time it’s different, though. Instead of telling Wylie where she is, Cassie sends cryptic clue.&hellip;
								</div>
								...
								<div class="product_details col-md-2">
									...
									<span class="price"><del>
											<span class="amount">Rs:850.00</span>
										</del> <ins>
