							...
							<thead>
								...
								<c:forEach items="${productList}" var="product">
									<tr>
										...
										<td><a
											href="<c:url value='product/edit/${product.id}' />"><button
													type="button" class="btn btn-primary">Edit</button></a></td>
										<td><a
											href="<c:url value='product/remove/${product.id}' />"><button
													type="submit" id="demo" Onclick="return myFunction();"
													value="1" class="btn btn-primary">Delete</button></a></td>
									</tr>
								</c:forEach>
							</thead>
						</table>
